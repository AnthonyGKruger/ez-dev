...
const themeAfterContentClasses =
  ...
  >
    <div class="relative flex flex-wrap items-center">
      ...
      <input
        ...
        ring-2 ring-inset ring-light-gold transition-all duration-300 bg-black
         after:flex after:justify-center after:items-center after:text-2xl after:absolute
         after:top-0 after:left-0 after:h-10 after:w-10 after:rounded-full after:bg-black
